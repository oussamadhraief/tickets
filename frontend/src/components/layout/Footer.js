...
<footer className="bg-white dark:bg-zinc-800 pt-4 pb-8 xl:pt-8">
        ...
        <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            <form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
                <div className=" relative ">
                    ...
                    <button className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-emerald-900 rounded-lg shadow-md hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200" type="submit">
                        Subscribe
                    </button>
                </form>
            </div>
